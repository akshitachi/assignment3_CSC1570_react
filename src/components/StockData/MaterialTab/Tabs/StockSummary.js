...
function StockSummary () {
  ...
  return (
    <div className={`stockSummary${window.innerWidth > 844 ? '' : 'big'}`}>
    <div className={`stockSummaryoverall${window.innerWidth > 844 ? '' : 'big'}`}>
      <div className={`stockSummaryheader${window.innerWidth > 844 ? '' : 'big'}`}>
      ...
      <div className={`about${window.innerWidth > 844 ? '' : 'big'}`}>
        ...
        <div className={`peerNames${window.innerWidth > 844 ? '' : 'big'}`}>{peersResult.map((peer) => <a key={peer} href={`/search/${peer}`}>{peer} </a>)}</div>
      </div>
    </div>
    <AggregateCharts/>
    </div>
