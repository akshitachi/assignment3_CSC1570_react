  ...
  if (ticker === undefined || searchResults === null || searchResults.ticker === null){
   ...
   const handleFavoriteClick = () => {
    if (!isFavorite) {
      ...
      // Code for removing from Watchlist
    }
  ...
  return (
    <div className="stock-column">
      {showMessage && (
        ...
        >
          <span style={{ marginRight: 480,
          marginLeft:450 }}>
          {isFavorite
            ? `${profile.ticker} added to Watchlist.`
            : `${profile.ticker} removed from Watchlist.`}
            </span>
            <FontAwesomeIcon onClick={closeMessage} className="x-icon" icon={faX}/>
        </div>
      )}
      <div className="stock-main">
        <div className="column1">
          <div className="row1">
            ...
            <div className={`favorite_icon ${isFavorite ? "favorite" : ""}`}>
            <FontAwesomeIcon
